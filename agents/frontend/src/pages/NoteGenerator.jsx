...
export default function NoteGenerator() {
  ...
  if (status === "loading") {
    ...
    summaryDetail = "Morrow is extracting goals, outcomes, risks, and participant voice now.";
  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div><div className="eyebrow mb-2">New progress note</div><h1 className="display-title max-w-[680px] text-[2.5rem] md:text-[3.2rem]">Good care deserves <span className="text-teal-600">a better record.</span></h1></div>
